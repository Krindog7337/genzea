...
<div class="overflow-hidden">
  <div id="hs-application-sidebar"
    class="hs-overlay fixed bottom-0 start-0 top-0 z-[60] hidden w-64 -translate-x-full transform overflow-y-auto border-e border-gray-200 bg-white duration-300 [--auto-close:lg] hs-overlay-open:translate-x-0 dark:border-neutral-700 dark:bg-neutral-900 lg:bottom-0 lg:end-auto lg:block lg:translate-x-0 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 [&::-webkit-scrollbar-track]:bg-gray-100 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 [&::-webkit-scrollbar]:w-2"
    role="dialog" tabindex="-1" aria-label="Sidebar">
    <nav class="flex size-full flex-col">
      <div class="flex items-center justify-between pe-4 ps-7 pt-4">
        <!-- Logo -->
        <a class="flex-none focus:opacity-80 focus:outline-none" href="index.php" aria-label="Genzea">
        ...
        <ul class="space-y-1.5 p-4">
          ...
          <li>
            <a class="flex items-center gap-x-3 rounded-lg px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:text-neutral-400 dark:hover:bg-neutral-900 dark:hover:text-neutral-300 dark:focus:bg-neutral-900 dark:focus:text-neutral-300"
              ...
              <box-icon name='video' class="size-4  block  fill-text/90"></box-icon>
              Video
            </a>
          </li>
          <li>
            <a class="flex items-center gap-x-3 rounded-lg px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:text-neutral-400 dark:hover:bg-neutral-900 dark:hover:text-neutral-300 dark:focus:bg-neutral-900 dark:focus:text-neutral-300"
              ...
              <box-icon name='notepad' class="size-4 block fill-text/90"></box-icon>
              Kuis
            </a>
          </li>
        </ul>
